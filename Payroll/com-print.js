...
const COM_DEFAULT_RETURN_URL = "com.html";
...
(function () {
  ...
  function getReturnUrl() {
    return sessionStorage.getItem(COM_PRINT_RETURN_KEY) || COM_DEFAULT_RETURN_URL;
  }

  function cleanupPrintSession() {
    sessionStorage.removeItem(COM_PRINT_PAYLOAD_KEY);
    sessionStorage.removeItem(COM_PRINT_RETURN_KEY);
  }
  ...
  function renderPayload() {
    const payload = sessionStorage.getItem(COM_PRINT_PAYLOAD_KEY);
